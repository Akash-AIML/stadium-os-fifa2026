...
def test_get_all_snapshots() -> None:
...
def test_get_snapshot_invalid_zone() -> None:
    with pytest.raises(ValueError):
        crowd_engine.get_snapshot("invalid_zone")


def test_density_to_status() -> None:
    # Regular values
